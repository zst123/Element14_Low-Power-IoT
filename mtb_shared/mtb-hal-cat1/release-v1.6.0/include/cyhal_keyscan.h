...
#define CYHAL_KEYSCAN_RSLT_ERR_INVALID_PIN        \
  (CYHAL_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_KEYSCAN, 0))

/** An invalid argument was provided */
#define CYHAL_KEYSCAN_RSLT_ERR_INVALID_ARG        \
  (CYHAL_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_KEYSCAN, 1))

/** Initialization of the KeyScan hardware failed */
#define CYHAL_KEYSCAN_RSLT_ERR_INIT_FAILED        \
  (CYHAL_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_KEYSCAN, 2))
